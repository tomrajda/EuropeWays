...
<template>
    <div class="container max-w-5xl mx-auto bg-zinc-200 bg-opacity-60 shadow-md rounded-lg px-10 pt-0 pb-12 mb-20">
      ...
      <div>
        <p class="text-2xl font-semibold text-gray-800">Choose option:</p>
      </div>
      <label class="inline-flex items-center">
        <div class="mt-2 py-4">
          ...
          <span class="ml-4 text-gray-700 text-lg">One way</span>
          ...
          <span class="ml-4 text-gray-700 text-lg">Return</span>
        </div>
      </label>
      ...
      <form @submit.prevent="handleSubmit" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-8">
        ...
        <button type="submit"
                ...
                class="w-full py-3 px-6 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-sky-800 hover:bg-sky-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-900 disabled:opacity-60">
          Search
        </button>
      </form>
      ...
      <div v-if="statusMessage" :class="[statusMessage === 'Flight successfully added!' ? 'bg-green-100 border border-green-400 text-green-700' : 'bg-red-100 border border-red-400 text-red-700', 'px-4 py-3 rounded relative mb-8']">
        ...
        <div v-if="cheapestFlight === null && !error && cheapestCallResponse !== null" class="text-gray-700 bg-white shadow-lg rounded-lg p-8 mb-8">
            <div class="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative mb-6" role="alert">
                <strong class="font-bold">No inbound flight found for this date!</strong>
        ...
        <div v-if="minFareOneWay && minFareOneWay.unavailable === false" class="bg-gray-50 shadow-md rounded-lg p-8 mt-4 mb-4">
            <h2 class="text-2xl font-bold mb-4">Check out other inbound flights below!</h2>
        ...
        <div v-if="cheapestReturnFlight === null && !error && cheapestReturnCallResponse !== null && selectedOption === 'return'" class="text-gray-700 bg-white shadow-md rounded-lg px-8 py-4 mb-8">
            <div class="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative mb-6" role="alert">
                <strong class="font-bold">No outbound flight found for this date!</strong>
                <span class="block sm:inline"> Try a different date.</span>
            </div>
        

        <div v-if="minFareReturn && minFareReturn.unavailable === false" class="bg-gray-50 shadow-md rounded-lg p-8 mt-4 mb-8">
            <h2 class="text-2xl font-bold mb-4">Check out other outbound flights below!</h2>
